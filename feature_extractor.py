...
def to_segments(
    ...
    """
    data = np.array(data)
    #print("Debug @98 ",type(data), len(data), data.shape)
    Segments_Features = []
...
class FeaturesWriter:
    ...
    def dump(self, dir: str) -> None:
        ...
        self.dump_count += 1
        self.dir = dir
        #print("Debug @152",self.dir)
        if not path.exists(self.dir):
            #os.mkdir(self.dir)
            os.makedirs(self.dir, exist_ok=True)
        #print("Debug @159", self.data)
        #####################################################
    ...
    with torch.no_grad():
        for data, clip_idxs, dirs, vid_names in data_iter:
            ...
            for i, (_dir, vid_name, clip_idx) in enumerate(
                ...
                #print("Debug @304",args.save_dir,_dir)
                _dir = path.join(args.save_dir, _dir)
                #print("Debug @306",_dir)
                #print("Debug @309",outputs[i].shape)
                global_dir = _dir
