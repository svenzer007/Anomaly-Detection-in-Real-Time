...
class FeaturesLoader:
    ...
    def __init__(
        ...
        #print("Debug @36 in __init__", self._features_path, annotation_path)
        # load video list
        (
        ...
        #print("Debug @44 in __init__", self.features_list_normal, self.features_list_anomaly)
    ...
    def get_features(self) -> Tuple[Tensor, Tensor]:
        ...
        #print("Debug @73", self.features_list_normal, self.features_list_anomaly)
    ...
    def _get_features_list(
        ...
        with open(annotation_path) as f:
            ...
            for line in lines:
                ...
                #print("Debug @line 118 in _get_featuers_list", feature_path, features_path, file)
                if "Normal" in feature_path:
                    features_list_normal.append(feature_path)
                else:
                    features_list_anomaly.append(feature_path)
        #print("Debug @123 in _get_features_list", features_list_normal, features_list_anomaly)
